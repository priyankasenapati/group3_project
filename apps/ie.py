...
#
# Predict Divorce outcome for one subject
# based on the production values entered on the website.
#
# A new user goes to the Divorce Prediction
# webpage and answers the questionaire of 54 questions.
# Divorce outcome is predicted based on the production values provided.
#

# Read the Machine Learning model
# from a file use for production inferencing
