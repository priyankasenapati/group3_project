...
# Split the Divirce dataset Into Training And Testing Datasets
# to help determine the accuracy of the model later.
# X values are the attribute values (answers to the 54 questions)
# Y values are the divorce outcome (Yes/No or 1/0)
# provided in the 55th column in the Divorce dataset
